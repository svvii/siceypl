...
if (isset($_GET['buscar'])) {
    ...
    if (!empty($termino) && !empty($tipo_busqueda)) {
        ...
        $sql = "SELECT id, CONCAT(apellido_p, ' ', apellido_m, ' ', nombre) AS nombre_completo, matricula, nombre_empresa, tutor_academico, asesor_academico, asesor_empresarial FROM estadiasb" . $filtrar;
...
<head>
    ...
    <link href="../Assets/css/balleza.css" rel="stylesheet">
    <link href="../Assets/css/esliloslogo.css" rel="stylesheet">
...
<header>
        ...
        <div class="title-center"><h1>SISTEMA INTEGRAL PARA EL CONTROL DE ESTADÍAS UNIDAD RIO BALLEZA</h1></div>
    ...
    if ($contadorResultados > 0) {
        ...
        while ($estadia = $resultado->fetch_assoc()) {
            ...
            echo "<td><a href='generar_qrballeza.php?id={$estadia['id']}' style='text-align: center; display: block;'><i class='fa-solid fa-qrcode' style='display: inline-block;'></i></a></td>";
            echo "</tr>";
        }
        echo "</table>";
    } else {
