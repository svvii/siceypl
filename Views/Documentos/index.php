...
<li class="breadcrumb-item active">Documentos de Estadias</li>
</ol>
<button class="btn btn-secondary mb-2" type="button" onclick="frmDocumento();"><i class="fas fa-plus"></i></button>
<div class="table-responsive">
<table class="table table-light" id="tblDocumentos">
...
<div id="nuevo_documento" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
            ...
            <div class="form-group">
                ...
                <select id="id_generacion" class="form-control" name="id_generacion">
                    ...
                    <?php foreach ($data['generaciones'] as $row) { ?>
                        <option value="<?php echo $row['id']; ?>"><?php echo $row['inicio']; ?><?php echo $row['final']; ?></option>
                    <?php } ?>
                </select>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                <label for="codigo_estadia">Código de Estadía</label>
                <input id="codigo_estadia" class="form-control" type="text" name="codigo_estadia" placeholder="Código de Estadía">
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
    ...
    <button class="btn btn-success" type="button" onclick="registrarDoc(event);" id="btnAccion">Registrar</button>
