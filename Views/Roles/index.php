...
<button class="btn btn-secondary mb-2" type="button" onclick="frmRol();"><i class="fas fa-plus"></i></button>
...
<div id="nuevo_rol" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <h5 class="modal-title text-white" id="title">Nuevo Acceso</h5>
            ...
            <div class="modal-body">
                ...
                <button class="btn btn-success" type="button" onclick="registrarRol(event);" id="btnAccion">Registrar</button>
